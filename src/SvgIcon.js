...
const SvgIcon = () => (
  ...
  >
    <g clipPath="url(#a)">
      ...
      <text
        x="115" // Отступ слева
        y="50%" // Вертикальный центр
        fontSize="24"
        fill="#ffffff" // Белый цвет
        style={{ fontFamily: "Noto Sans, sans-serif", fontWeight: 700 }} // Указание шрифта через style
        textAnchor="middle" // Горизонтальное выравнивание по центру
        dominantBaseline="middle" // Вертикальное выравнивание по центру
      >
        Extensions
      </text>
    </g>
